...
?>
    ...
    <div class="form-container">
      ...
      <p style="text-align: center">Hi Chief!,Welcome back.
      <br> Your session has Expire,Please Login.</p>
      <form method="post" id="form_id">
      
      <label for="email"><b>Email:</b></label>
      <br>
      <input type="email" name="email" id="form_email" autofocus="off" size="25"   placeholder="Enter mail...">
