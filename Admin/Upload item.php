...
$item_name = $item_price = $item_discount_price = $item_image = "";
...
$image_name = $item_name ."-". rand(). uniqid();
...
$hash_id = uniqid().rand().rand(123,986);
...
'$item_name','$item_price','$item_discount_price',
  ...
  if (mysqli_query($conn,$upload)){
   ...
   // echo mysqli_error($conn);
    die("Fail to upload item ".mysqli_error($conn));
